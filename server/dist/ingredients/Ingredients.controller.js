...
const add_ingredient_dto_1 = require("./dto/add-ingredient.dto");
...
let IngredientsController = class IngredientsController {
    ...
    findAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ingredientsService.findAll(req.user.id);
        });
    }
    addIngredient(ingredientInfo, req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ingredientsService.addIngredient(ingredientInfo, req.user.id);
        });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [add_ingredient_dto_1.AddIngredientDto, Object]),
    __metadata("design:returntype", Promise)
], IngredientsController.prototype, "addIngredient", null);
