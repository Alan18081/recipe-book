...
let IngredientsService = class IngredientsService {
    ...
    findAll(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ingredientsRepository.find({ userId });
        });
    }
    addIngredient(ingredientInfo, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const newIngredient = Object.assign({}, new ingredient_entity_1.Ingredient(), ingredientInfo, { userId: id });
            return yield this.ingredientsRepository.save(newIngredient);
        });
    }
};
